...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'Energy' => 'Energia',
    'Engineering' => 'Inżyniera',
    'Entertainment' => 'Rozrywka',
    'Environmental' => 'Środowisko',
    'Finance' => 'Finanse',
    'Government' => 'Instytucja rządowa / samorządowa',
...
//prospect list type dom
  ...
  'navigation_paradigms' => array(
    ...
    'chart_strings' => array (
        'expandlegend'      => 'Rozwiń legende',
        'collapselegend'    => 'Zwiń legende',
  ...
  array(
    ...
    'greater_than' => 'Jest większe',
    'greater_than_equals' => 'Jest większe lub równe',
    'less_than' => 'Jest mniejsze',
    'less_than_equals' => 'Jest mniejsze lub równe',
...
$app_strings = array (
  ...
  'LBL_JS_CALENDAR' => 'Kalendarz' /*for 508 compliance fix*/,
    ...
    'LBL_NO_ACTION'                         => 'Nie istnieje działanie o wskazanej nazwie.',
    'LBL_NO_DATA'                           => 'Brak danych',
    'LBL_ROUTING_ADD_RULE'                  => 'Dodaj regułę',
    'LBL_ROUTING_ALL'                       => 'Conajmniej',
    'LBL_ROUTING_ANY'                       => 'Any',
    'LBL_ROUTING_BREAK'                     => '-',
    ...
    'LBL_ROUTING_ACTIONS_FORWARD'           => 'Przekieruj wiadomość',
    'LBL_ROUTING_ACTIONS_MARK_FLAGGED'      => 'Oflaguj wiadomość',
    ...
    'LBL_ROUTING_ACTIONS_PEFORM'            => 'Wykonaj następujące działania',
    'LBL_ROUTING_ACTIONS_REPLY'             => 'Odpowiedz na wiadomość',

    'LBL_ROUTING_CHECK_RULE'                => "Znaleziono błąd:\n",
    'LBL_ROUTING_CHECK_RULE_DESC'           => 'Proszę sprawdź wszystkie zaznaczone pola.',
    'LBL_ROUTING_CONFIRM_DELETE'            => "Czy na pewno chcesz usunąć regułę?\nNie będzie można cofnąć tego działania.",

    'LBL_ROUTING_FLAGGED'                   => 'flag set',
    'LBL_ROUTING_FORM_DESC'                 => 'Zapisane reguły są natychmiast aktywne.',
    'LBL_ROUTING_FW'                        => 'FW: ',
    'LBL_ROUTING_LIST_TITLE'                => 'Regugły',
  ...
  'LBL_DROP_HERE' => '[Drop Here]',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPAUTH_REQ'       => 'Użyj autoryzacji SMTP?',
    'LBL_EMAIL_ACCOUNTS_SMTPPASS'           => 'Hasło SMTP',
    'LBL_EMAIL_ACCOUNTS_SMTPPORT'           => 'Port SMTP',
    'LBL_EMAIL_ACCOUNTS_SMTPSERVER'         => 'Serwer SMTP',
    'LBL_EMAIL_ACCOUNTS_SMTPSSL'            => 'Użyj SSL w trakcie połączenia',
    'LBL_EMAIL_ACCOUNTS_SMTPUSER'           => 'Użytkownik SMTP',
    'LBL_EMAIL_ACCOUNTS_SMTPDEFAULT'        => 'Domyślne',
    'LBL_EMAIL_WARNING_MISSING_USER_CREDS'  => 'Ostrzeżenie: Brak użytkownika i hasła dla poczty wychodzącej.',
    'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD'      => 'Użytkownik SMTP wymagany',
    'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD'      => 'Hasło SMTP wymagane',
  ...
  'LBL_EMAIL_ACCOUNTS_OUTBOUND_SUBTITLE'  => 'Provide SMTP mail server information to use for outgoing email in Mail Accounts.',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_ADD'            => 'Gotowe',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR'     => 'Adres email',
    ...
    'LBL_EMAIL_ADDRESSES_TITLE'             => 'Adresy email',
    'LBL_EMAIL_ARCHIVE_TO_SUGAR'            => 'Import to Sugar',
    'LBL_EMAIL_ASSIGNMENT'                  => 'Assignment',
    'LBL_EMAIL_ATTACH_FILE_TO_EMAIL'        => 'Załącznik',
    'LBL_EMAIL_ATTACHMENT'                  => 'Załącznik',
    ...
    'LBL_EMAIL_CHECKING_NEW'                => 'Sprawdzanie nowych wiadomości',
    ...
    'LBL_EMAIL_CREATE_NEW'                  => '--Utwórz podczas zapisu--',
    'LBL_EMAIL_MULT_GROUP_FOLDER_ACCOUNTS'  => 'Multiple',
    'LBL_EMAIL_MULT_GROUP_FOLDER_ACCOUNTS_EMPTY' => 'Puste',
    'LBL_EMAIL_DATE_SENT_BY_SENDER'         => 'Data wysłania',
  'LBL_EMAIL_DATE_RECEIVED'               => 'Data otrzymania',
    'LBL_EMAIL_ASSIGNED_TO_USER'            =>'Przypisane do użytkownika',
    ...
    'LBL_EMAIL_DELETE_SUCCESS'              => 'Wiadomość email została usunięta.',
    'LBL_EMAIL_DELETING_MESSAGE'            => 'Usuwanie wiadomości',
    'LBL_EMAIL_DETAILS'                     => 'Szczegóły',
    'LBL_EMAIL_DISPLAY_MSG'                 => 'Wyświetlane wiadomości {0} - {1} z {2}',
    ...
    'LBL_EMAIL_ERROR_CHECK_IE_SETTINGS'     => 'Proszę sprawdź ustawienia.',
    'LBL_EMAIL_ERROR_CONTACT_NAME'          => 'Please make sure you enter a last name.',
    'LBL_EMAIL_ERROR_DESC'                  => 'Znaleziono błędy: ',
    ...
    'LBL_EMAIL_ERROR_EMPTY'                 => 'Wprowadź kryteria wyszukiwania.',
    ...
    'LBL_EMAIL_ERROR_SERVER'                => 'Adres serwera email jest wymagany.',
    ...
    'LBL_EMAIL_ERROR_PROTOCOL'              => 'Protokół serwera jest wymagany.',
    ...
    'LBL_EMAIL_FOLDERS_CHANGE_HOME'         => 'Nie można dokonać zmian dla tego folderu',
    ...
    'LBL_EMAIL_MENU_RENAMING_FOLDER'        => 'Zmianianie nazwy folderu',
    ...
    'LBL_EMAIL_QC_CASES'                    => 'Zgłoszenie serwisowe',
    ...
    'LBL_EMAIL_SAVE_DRAFT'                  => 'Zapisz wersje roboczą',
    ...
    'LBL_EMAIL_SEARCH_NO_RESULTS'           => 'Brak wyników spełniających kryteria wyszukiwania.',
    'LBL_EMAIL_SEARCH_RESULTS_TITLE'        => 'Wyniki wyszukiwania',
    'LBL_EMAIL_SEARCH_TITLE'                => 'Proste wyszukiwanie',
    'LBL_EMAIL_SEARCH__FROM_ACCOUNTS'       => 'Przeszukaj skrzynkę pocztową',
    ...
    'LBL_EMAIL_SETTINGS_2_ROWS'             => '2 kolumny',
    ...
    'LBL_EMAIL_SETTINGS_NAME'               => 'Nazwa skrzynki pocztowej',
    ...
    'LBL_EMAIL_SETTINGS_RULES'              => 'Reguły wiadomości',
    ...
    'LBL_EMAIL_SETTINGS_SHOW_NUM_IN_LIST'   => 'Wiadomości na stronie',
    'LBL_EMAIL_SETTINGS_TAB_POS'            => 'Place Tabs at Bottom',
    'LBL_EMAIL_SETTINGS_TITLE_LAYOUT'       => 'Ustawienia wyświetlania',
  ...
  'LBL_EMAIL_INVALID_SYSTEM_OUTBOUND' => 'An outgoing mail server is not configured to send emails. Please configure an outgoing mail server or select an outgoing mail server for the mail account that you are using in Settings >> Mail Account.',
    'LBL_EMAIL_SHOW_READ'                   => 'Wyświetl wszystko',
    'LBL_EMAIL_SHOW_UNREAD_ONLY'            => 'Wyświetl nieprzeczytane',
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'LBL_EMAIL_TEXT_REFRESH'                => 'Odswież',
    'LBL_EMAIL_TO'                          => 'Do',
    ...
    'LBL_EMAIL_YES'                         => 'Tak',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS'      => 'Wyślij testową wiadomość email',
    'LBL_EMAIL_TEST_OUTBOUND_SETTINGS_SENT' => 'Testowa wiadomość email wysłana',
    ...
    'LBL_CLOSE_ACTIVITY_CONFIRM' => "Czy na pewno chcesz zamknąć ten #module#?",
    'LBL_CLOSE_ACTIVITY_REMEMBER' => "Nie wyświetlaj tego powiadomienia w przyszłości: &nbsp;",
    ...
    'LBL_REPLACE_BUTTON' => 'Zamień',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_KEY' => 'L',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_LABEL' => 'Add To Target List',
    'LBL_ADD_TO_PROSPECT_LIST_BUTTON_TITLE' => 'Add To Target List',
    'LBL_ADDITIONAL_DETAILS_CLOSE_TITLE' => 'Kliknij żeby zamknąć',
    'LBL_ADDITIONAL_DETAILS_CLOSE' => 'Zamknij',
    'LBL_ADDITIONAL_DETAILS' => 'Dodatkowe informacje',
    'LBL_ADMIN' => 'Panel administratora',
    'LBL_ALT_HOT_KEY' => '',
    'LBL_ARCHIVE' => 'Archive',
    'LBL_ASSIGNED_TO_USER'=>'Przypisane do użytkownika',
    'LBL_ASSIGNED_TO' => 'Przypisane do:',
    'LBL_BACK' => 'Powrót',
    'LBL_BILL_TO_ACCOUNT'=>'Fakturuj konto',
    'LBL_BILL_TO_CONTACT'=>'Fakturuj kontakt',
    ...
    'LBL_CALLS'=>'Telefony',
    'LBL_CALL'=>'Telefon',
    'LBL_CAMPAIGNS_SEND_QUEUED' => 'Wyślij zakolejkowane wiadomości email kampanii',
    'LBL_SUBMIT_BUTTON_LABEL' => 'Wyślij',
    'LBL_CASE'=>'Zgłoszenie serwisowe',
    'LBL_CASES'=>'Zgłoszenia serwisowe',
    ...
    'LBL_OPEN_ITEMS' => 'Otwarte elementy:',
    'LBL_COMPOSE_EMAIL_BUTTON_KEY' => 'L',
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => 'Napisz email',
    'LBL_COMPOSE_EMAIL_BUTTON_TITLE' => 'Napisz Email',
    ...
    'LBL_CREATED_USER'=>'Utworzono przez użytkownika',
    ...
    'LBL_LAST_VIEWED' => 'Ostatnio wyświetlone',
    ...
    'LBL_LISTVIEW_MASS_UPDATE_CONFIRM' => 'Czy na pewno chcesz zaktualizować całą listę?',
    'LBL_LISTVIEW_NO_SELECTED' => 'Proszę wybierz conajmniej 1 rekord żeby kontynuować.',
    'LBL_LISTVIEW_TWO_REQUIRED' => 'Proszę wybierz conajmniej 2 rekordy żeby kontynuować.',
    'LBL_LISTVIEW_LESS_THAN_TEN_SELECT' => 'Proszę wybierz mniej niż 10 rekordów żeby kontynuować.',
    'LBL_LISTVIEW_ALL' => 'Wszystkie',
    'LBL_LISTVIEW_NONE' => 'Odznacz wszystko',
    'LBL_LISTVIEW_OPTION_CURRENT' => 'Zaznacz stronę',
    ...
    'LBL_MASS_UPDATE' => 'Edycja wielu rekordów',
    ...
    'LBL_MEETING_GO_BACK'=>'Powrót do spotkania',
    'LBL_MEMBERS'=>'Members',
    'LBL_MEMBER_OF'=>'Obiekt nadrzędny',
    ...
    'LBL_PRIMARY_ADDRESS' => 'Adres podstawowy Ulica:',
    ...
    'LBL_RELATED_INFORMATION' => 'Powiązane informacje',
    'LBL_RELATED_RECORDS' => 'Powiązane rekordy',
    'LBL_REMOVE' => 'Usuń',
    'LBL_REPORTS_TO' => 'Przełożony',
    'LBL_REQUIRED_SYMBOL' => '*',
    'LBL_REQUIRED_TITLE' => 'Wskazuje pola wymagane',
    'LBL_EMAIL_DONE_BUTTON_LABEL' => 'Gotowe',
    ...
    'LBL_SAVE_NEW_BUTTON_LABEL' => 'Zapisz i utwórz nowy',
    'LBL_SAVE_NEW_BUTTON_TITLE' => 'Zapisz i utwórz nowy',
    'LBL_SAVE_OBJECT' => 'Zapisz {0}',
    'LBL_SEARCH_BUTTON_KEY' => 'Q',
    'LBL_SEARCH_BUTTON_LABEL' => 'Wyszukaj',
    'LBL_SEARCH_BUTTON_TITLE' => 'Wyszukaj',
    'LBL_SEARCH' => 'Wyszukaj',
    ...
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_TITLE' => 'Wybierz kampanie',
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_LABEL' => 'Wybierz kampanie',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_TITLE' => 'Wyczyść kampanie',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_LABEL' => 'Wyczyść kampanie',
    ...
    'LBL_SERVER_RESPONSE_RESOURCES' => 'Zasoby wykorzystane do wygenerowania tej strony (zapytania, pliki)',
    'LBL_SERVER_RESPONSE_TIME_SECONDS' => 'sekund.',
    'LBL_SERVER_RESPONSE_TIME' => 'Czas generowania strony:',
    'LBL_SERVER_MEMORY_BYTES' => 'bajtów',
    'LBL_SERVER_MEMORY_USAGE' => 'Zużycie pamięci przez serwer: {0} ({1})',
    'LBL_SERVER_MEMORY_LOG_MESSAGE' => 'Zużycie: - moduł: {0} - działanie: {1}',
    'LBL_SERVER_PEAK_MEMORY_USAGE' => 'Server Peak Memory Usage: {0} ({1})',
    'LBL_SHIP_TO_ACCOUNT'=>'Dostawa do konta',
    'LBL_SHIP_TO_CONTACT'=>'Dostawa do kontaktu',
    ...
    'LBL_VIEW_PDF_BUTTON_LABEL' => 'Zapisz jako PDF',
    'LBL_VIEW_PDF_BUTTON_TITLE' => 'Zapisz jako PDF',


    'LNK_ABOUT' => 'About',
    'LNK_ADVANCED_SEARCH' => 'Wyszukiwanie zaawansowane',
    'LNK_BASIC_SEARCH' => 'Podstawowe wyszukiwanie',
    'LNK_SEARCH_FTS_VIEW_ALL' => 'Wyświetl wszystkie wyniki',
    'LNK_SEARCH_NONFTS_VIEW_ALL' => 'Wyświetl wszystkie',
    'LNK_CLOSE' => 'zamknij',
    'LBL_MODIFY_CURRENT_SEARCH'=> 'Modyfikuj aktualne wyszukiwanie',
    'LNK_SAVED_VIEWS' => 'Ustawienia widoku',
    ...
    'LNK_CREATE' => 'Utwórz',
    'LNK_LIST_END' => 'Koniec',
    'LNK_LIST_NEXT' => 'Następna',
    'LNK_LIST_PREVIOUS' => 'Poprzednia',
    'LNK_LIST_RETURN' => 'Powrót do listy',
    'LNK_LIST_START' => 'Start',
    'LNK_LOAD_SIGNED'=>'Sign',
    'LNK_LOAD_SIGNED_TOOLTIP'=>'Replace with signed document',
    'LNK_PRINT' => 'Drukuj',
    'LNK_BACKTOTOP' => 'Powrót do góry',
    'LNK_REMOVE' => 'usuń',
    'LNK_RESUME' => 'Resume',
    'LNK_VIEW_CHANGE_LOG' => 'Wyświetl historię zmian',


    'NTC_CLICK_BACK' => 'Proszę kliknij przycisk wstecz w przeglądarce żeby naprawić ten błąd.',
    ...
    'NTC_LOGIN_MESSAGE' => 'Proszę podaj nazwę użytkownika i hasło.',
    'NTC_NO_ITEMS_DISPLAY' => 'brak',
    'NTC_REMOVE_CONFIRMATION' => 'Czy na pewno chcesz usunąć relację? Usunięta zostanie wyłącznie relacja. Rekord pozostanie bez zmian.',
    'NTC_REQUIRED' => 'Wskazuje wymagane pole',
    ...
    'ERROR_TYPE_NOT_VALID' => 'Błąd. Nieprawidłowy typ.',
    'ERROR_NO_BEAN' => 'Failed to get bean.', 
    'LBL_DUP_MERGE'=>'Znajdź duplikaty',
    ...
    'LBL_UNSUBSCRIBE'=>'Wypisz z subskrybcji',
    // Ajax status strings
    ...
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\nKliknij OK żeby wyświetlić telefon lub ANULUJ żeby zamknąć okno.",
  	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\nKlikninj OK żeby wyświetlić spotkanie lub ANULUJ żeby zamknąć okno.",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "Nie znaleziono wyników.",
	'MSG_LIST_VIEW_NO_RESULTS' => "Nie znaleziono wyników dla <item1>",
 	'MSG_LIST_VIEW_NO_RESULTS_SUBMSG' => "Utwórz <item1> jako nowe(y) <item2>",
    ...
    'LBL_MARK_AS_FAVORITES' => 'Oznacz jako ulubione',
    ...
    'LBL_REDIRECT_URL'=>'URL przekierowania',
  ...
  'LBL_ALT_ADDRESS' => 'Adres (inny):',
    ...
    'LBL_LOADING_PAGE' => 'Wczytywanie strony...',

    'LBL_RELOAD_PAGE' => 'Proszę <a href="javascript: window.location.reload()">odśwież okno</a> to use this Sugar Dashlet.',
  ...
  'MSG_OR_GREATER' => 'or greater',
    ...
    //jchi #  20776
    'LBL_DROPDOWN_LIST_ALL' => 'Wszystkie',
  ...
  'LBL_NEXT_YEAR'=> 'następny rok',
    ...
    'LBL_ENTER_VALID_YEAR' => 'Proszę wprowadzić prawidłowy rok',
  ...
  'ERR_FILE_NOT_FOUND' => 'Error: Could not load file {0}.  Please check system and web server permissions.',
    ...
    'LBL_RSS_RECORDS_FOUND' => 'rekordów znaleziono',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_EXPORT_ASSIGNED_USER_ID' => 'Przypisane do',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => 'Przypisane użytkownik',
    'LBL_EXPORT_REPORTS_TO_ID' => 'Reports To ID',
    'LBL_EXPORT_FULL_NAME' => 'Pełna nazwa',
    'LBL_EXPORT_TEAM_ID' => 'Zespół ID',
    ...
    'LBL_ALT_SORT' => 'Sortuj',
    'LBL_ALT_SHOW_OPTIONS' => 'Wyświetl opcje',
    ...
    'LBL_SELECT_THIS_ROW_TITLE' => 'Zaznacz wiersz',
...
$app_list_strings['library_type'] = array('Books'=>'Książka', 'Music'=>'Muzyka', 'DVD'=>'DVD', 'Magazines'=>'Magazyny');
...
$app_list_strings['kbdocument_status_dom'] = array (
   ...
   $app_list_strings['kbadmin_actions_dom'] =
    ...
    'Create New Tag' => 'Dodaj Tag',
    'Delete Tag'=>'Usuń Tagi',
    'Rename Tag'=>'Zmień nazwę Tagu',
    'Move Selected Articles'=>'Przenieś zaznaczone artykuły',
    'Apply Tags On Articles'=>'Dodaj Tagi do artykułów',
